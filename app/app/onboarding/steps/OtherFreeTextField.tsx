...
/**
 * The "other" free-text line under a step's option grid, with the label,
 * the character counter that appears near the cap, and the input. Shared
 * by the acquisition, prior-apps and learning-goal steps so the cap, the
 * counter threshold and the over-limit styling live in one place.
 */
  ...
  return (
    <div className="max-w-md mx-auto w-full mt-4 px-4 animate-in fade-in slide-in-from-top-2 duration-300">
      <div className="flex items-baseline justify-between gap-2 mb-2">
        <label htmlFor={id} className="text-muted-sm">
          {label}
        </label>
        {showCharCount ? (
          <span
