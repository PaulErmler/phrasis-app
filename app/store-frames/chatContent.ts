...
export const SAMPLES: Sample[] = [
  ...
  },
  {
    ...
    card: {
      base: 'I hope he goes to the doctor.',
      target: 'Espero que vaya al médico.',
    },
  },
  {
    id: 'register',
    ...
    card: {
      base: 'Excuse me, could you help me?',
      target: 'Disculpe, ¿me puede ayudar?',
    },
  },
  {
    id: 'ser-estar',
    ...
    card: {
      base: 'He is tired after the trip.',
      target: 'Está cansado después del viaje.',
    },
  },
  {
    id: 'past-tenses',
    ...
    card: {
      base: 'I was eating when you called.',
      target: 'Comía cuando llamaste.',
    },
  },
];
...
export const REJECT_SAMPLE = {
  ...
  cards: [
    {
      base: 'Thanks, but I would rather not.',
      target: 'Gracias, pero prefiero que no.',
    },
    { base: 'Maybe another time.', target: 'Quizá en otra ocasión.' },
    {
      base: 'I am afraid I cannot today.',
      target: 'Me temo que hoy no puedo.',
    },
  ],
};
