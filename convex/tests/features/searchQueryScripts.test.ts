...
const SCRIPT_CLASSES: ScriptClass[] = [
  ...
  },
  {
    ...
    query:
      'Añoréis la canción más allá del jardín pequeño después del café'.normalize(
        'NFD',
      ),
  ...
  },
  {
    ...
    codes: ['vi', 'vi_south'],
    query:
      'Tôi sẽ đến trường vào ngày mai và gặp bạn bè ở quán cà phê'.normalize(
        'NFD',
      ),
    triggersLegacyBug: true,
  },
  ...
  },
  {
    ...
    codes: ['th'],
    query:
      'พูดช้าๆหน่อยได้ไหมครับ ผมไม่เข้าใจ ช่วยพูดอีกครั้งได้ไหม ขอบคุณมากครับ',
    triggersLegacyBug: true,
  },
  {
...
describe('augmentSearchQuery: every supported script class', () => {
  ...
  describe.each(SCRIPT_CLASSES)(
    '$name',
    ({ codes, query, triggersLegacyBug }) => {
