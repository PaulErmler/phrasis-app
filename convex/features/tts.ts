/**
 * Shared TTS helper. Used by features/ttsProcessing.ts, writingAlternatives.ts
 * and chat/approvalAudio.ts. No Convex function exports; just plain async
 * helpers.
 *
 * Provider-specific TTS synthesis lives behind the `TTSProvider` interface in
 * ../lib/tts. Speech-to-text is its own module (../lib/stt, MAI-Transcribe-2
 * via OpenRouter). Text-comparison utilities live in ../lib/textComparison.ts
