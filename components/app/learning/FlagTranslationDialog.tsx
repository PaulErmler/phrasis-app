...
const REASONS: FlagReason[] = ['wrong_translation', 'wrong_gender', 'other'];

const NOTE_MAX_LENGTH = 500;

/**
 * The Flag dialog: a multi-select of what is wrong, with a speaker pick
 * under "wrong speaker gender". The pick is offered only for curriculum
 * cards (`allowCorrections`): a learner's own sentence has no shared
 * rendering to correct.
 */
