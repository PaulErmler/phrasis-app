...
Unblocking would require either `t.registerComponent("../../node_modules/@convex-dev/agent/src/component", ...)` (fragile, it rides on the compiled module layout) or a production-side seam injecting a fake threads component (production change).
